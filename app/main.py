...
def add_sidebar():
    st.sidebar.header("Cell Nuclei Meassures")
...
def add_predictions(input_data):
    ...
    benign_prob = round((model.predict_proba(input_array_scaled)[0][0]) * 100, 2)
    malicius_prob = round((model.predict_proba(input_array_scaled)[0][1]) * 100, 2)

    st.write("Probability of being benign: ", benign_prob)
    st.write("Probability of being benign: ", malicius_prob )
...
def main():
    ...
    with st.container():
        ...
        st.write("Please connect this app to your cytology lab to help diagnose breast cancer from your tissue sample. This apps predicts using a machine learning model whether a breas mass is benign or malingn based on the measurements. ")
